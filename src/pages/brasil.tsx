...
<<<<<<< HEAD
    <div className="flex flex-row align-center justify-center text-lincoln-green font-bold text-4xl">
    ...
    <div className='flex align-center justify-center p-3 font-bold text-2xl'>
      <h1>
        JOGOS QUE GARANTIRAM OS TÍTULOS
      </h1>
    </div>
    <div className='flex flex-col align-center justify-center gap-4'>
  <div className="p-3 bg-lincoln-green max-w-xl rounded-2xl flex flex-col align-center justify-center">
    ...
    <div className='flex flex-col text-justify align-center justify-center'>
  ...
  <div className='flex align-center justify-center p-11 font-bold text-2xl'>
      <h1>
        JOGOS QUE MARCARAM
      </h1>
    </div>
...
>>>>>>> 1f9daeb09956b0d705dfec4b429b9e711494126c
  )
};
